...
// Play opening notes during pattern display
if (soundEnabled) {
    playTone(523, 150);   // C5
    delay(10);
    playTone(659, 150);   // E5
    delay(10);
    playTone(784, 150);   // G5
    delay(670);  // Rest of the 1 second
}
...
// Run animation until all cells leave the screen or max generations
    ...
    // Play rising melody as animation completes
if (soundEnabled) {
    playTone(784, 100);   // G5
    delay(10);
    playTone(880, 100);   // A5
...
// Triumphant finish notes
if (soundEnabled) {
    playTone(1047, 150);  // C6
    delay(10);
    playTone(1319, 150);  // E6
    delay(10);
    playTone(1568, 250);  // G6 - hold for emphasis
    delay(50);
}
        ...
        if (isBtnUp()) {
            if (now - lastUpPress >= 150) {
                ...
                if (inToolsSubMenu) {
                    ...
                    toolsSelection = (toolsSelection > 1) ? toolsSelection - 1 : 2;
